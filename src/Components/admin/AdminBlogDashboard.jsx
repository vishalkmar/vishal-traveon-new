                ...
                <table className="w-full min-w-[500px]">
                  <thead>
                    <tr className="bg-gradient-to-r from-slate-50 to-slate-100 border-b border-slate-200">
                      <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Image</th>
                      <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Name</th>
                      <th className="hidden sm:table-cell px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Description</th>
                      <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-center text-xs sm:text-sm font-semibold text-slate-900">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {destinations.map((destination) => (
                      <tr key={destination.id} className="border-b border-slate-200 hover:bg-slate-50 transition">
                        ...
                        <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 font-medium text-xs sm:text-sm text-slate-900 truncate">{destination.name}</td>
                        <td className="hidden sm:table-cell px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-xs sm:text-sm text-slate-700 max-w-xs truncate">
                        ...
                        <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4">
                          <div className="flex justify-center gap-1 sm:gap-3">
                            <button
                              ...
                              className="p-1.5 sm:p-2 hover:bg-blue-100 text-blue-600 rounded-lg transition text-xs sm:text-base"
                              title="Edit"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 sm:p-2 hover:bg-red-100 text-red-600 rounded-lg transition disabled:opacity-50 text-xs sm:text-base"
                              title="Delete"
                            >
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[600px]">
                  <thead>
                    <tr className="bg-gradient-to-r from-slate-50 to-slate-100 border-b border-slate-200">
                      <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Image</th>
                      <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Title</th>
                      <th className="hidden md:table-cell px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Destination</th>
                      <th className="hidden lg:table-cell px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Excerpt</th>
                      <th className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-center text-xs sm:text-sm font-semibold text-slate-900">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {blogs.map((blog) => (
                      <tr key={blog.id} className="border-b border-slate-200 hover:bg-slate-50 transition">
                        ...
                        <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4 font-medium text-xs sm:text-sm text-slate-900 truncate">{blog.title}</td>
                        <td className="hidden md:table-cell px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-xs sm:text-sm text-slate-700 truncate">
                          {blog.destination?.name || "N/A"}
                        </td>
                        <td className="hidden lg:table-cell px-2 sm:px-4 md:px-6 py-3 sm:py-4 text-xs sm:text-sm text-slate-700 max-w-xs truncate">
                          {blog.excerpt}
                        </td>
                        <td className="px-2 sm:px-4 md:px-6 py-3 sm:py-4">
                          <div className="flex justify-center gap-1 sm:gap-3">
