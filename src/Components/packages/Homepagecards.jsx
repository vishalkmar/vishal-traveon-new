            ...
            <div className="mt-3 flex items-end justify-between gap-3">
                <div className="min-w-0">
                    {item?.pricing?.oldPrice && (
                        <div className="text-xs text-slate-500 line-through">{formatPriceWithSymbol(item.pricing.oldPrice)}</div>
                    )}
                    <div className="flex items-baseline gap-2">
                        <div className="text-xl font-extrabold text-slate-900">{formatPriceWithSymbol(item?.pricing?.price)}</div>
