...
const focusAreas = ['Yoga', 'Sound Healing', 'Chakra Work', 'Spirituality'];
...
const schedule = [
  ...
  },
  {
    ...
    items: [
      ...
      '3:30–4:00 PM: Tea Break + Self-Reflection',
      '4:05–5:15 PM: Ananta Prana Sadhana',
  ...
  },
  {
    ...
    tags: ['Breakfast', 'Lunch', 'Dinner'],
    items: [
      '6:30–7:30 AM: Shatkriya (Kapalbhati + Agnisar) + Tratak + Light Yoga',
      '8:00–9:00 AM: Breakfast',
      '9:30–12:30 PM: Optional Reiki Level 1 Attunement / Ganga dip / Self-Time',
      '1:00–2:00 PM: Lunch',
      '4:00–6:00 PM: Cyclic Meditation',
...
const notIncluded = [
  'Flights',
  'Personal Reiki/Attunement sessions',
];
...
const trainers = [
  {
    ...
    avatar: '/trainer1.jpg',
    tags: ['Ashtanga Yoga', 'Kundalini Yoga', 'Energy Healing', 'Swar Yoga'],
  },
];
  ...
  return (
    <aside className="w-full lg:w-[360px] shrink-0">
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 mb-6">
        <div className="text-3xl font-bold text-gray-900 text-center">₹30,000</div>
          ...
          <div className="p-4 space-y-3">
            <div className="rounded-lg border-2 border-emerald-200 bg-emerald-50 p-3">
              <div className="flex items-center justify-between">
                <div className="font-semibold text-gray-800">Double Occupancy</div>
                <div className="font-bold text-gray-900">₹50,000</div>
              </div>
              <div className="text-xs text-emerald-700 mt-1">Share with a companion</div>
            </div>
            <div className="rounded-lg border border-gray-200 p-3">
              <div className="flex items-center justify-between">
                <div className="font-medium text-gray-700">Single Occupancy</div>
        ...
        <div className="mt-4">
          <div className="text-sm font-medium text-gray-800 mb-2">What’s included:</div>
        ...
        <div className="mt-5 space-y-3">
          <Link to="https://wa.me/9540111307?text=Hi! I'm interested to book a package." target='_blank' className="w-full inline-flex justify-center items-center h-11 rounded-md text-white bg-[#28bccf] hover:bg-[#22a5b6] font-medium transition" >
            Book Now
          </Link>
          <Link to="mailto:info@traveon.in?subject=Quote%20Request&body=Hello,%20I%20would%20like%20to%20request%20a%20quote." target='_blank' className="w-full inline-flex justify-center items-center h-11 rounded-md border border-gray-200 bg-white text-gray-700 hover:bg-gray-50 font-medium transition">
            Request Quote
          </Link>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 mb-6">
        ...
        <div className="mt-3 flex items-center justify-between rounded-lg border border-gray-200 p-3">
          <div className="text-sm text-gray-700">27 Nov 2025 – 30 Nov 2025</div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 mb-6">
        <div className="text-sm font-medium text-gray-800 mb-3">Conducted by</div>
        <div className="flex items-center gap-3">
          ...
          />
          <div className="text-sm text-gray-700">Arunanand Saraswati</div>
        </div>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-10 md:py-14">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            {/* About */}
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-gray-900">About This Experience</h2>
            ...
            {/* Trainers */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-900">Meet Your Trainers</h3>
              <div className="mt-4 space-y-4">
                {trainers.map((t) => (
                  <div key={t.name} className="rounded-xl border border-gray-200 p-5 flex gap-4 items-start bg-white">
                    ...
                    <div>
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {t.tags.map((tag) => (
                          <span key={tag} className="px-2 py-1 text-xs rounded-full bg-purple-50 text-purple-700 border border-purple-200">
                            {tag}
                          </span>
                        ))}
                      </div>
...
export default RetreatsPackageDetails1;