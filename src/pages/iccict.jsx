...
export default function Iccict(){
    ...
    { type: "image", src: "/iccictimages/ic1.jpg" },
    { type: "image", src: "/iccictimages/ic3.jpg" },
    { type: "image", src: "/iccictimages/ic4.jpg" },
      { type: "image", src: "/iccictimages/ic5.JPG" },
        { type: "image", src: "/iccictimages/ic6.JPG" }
    ...
    <div className="flex flex-col items-center text-center">
      ...
      <div className="relative mb-6">
        ...
        <div className="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-b from-sky-500/25 to-sky-500/10 ring-1 ring-slate-200 shadow-[0_18px_60px_rgba(2,132,199,0.18)] md:h-28 md:w-28">
          ...
          <img
            src="/iccictimages/iccictlogo.jpg"
            alt="Coursera"
      ...
      <h1 className="max-w-3xl text-balance text-2xl font-semibold leading-tight md:text-4xl">
        2-Day International Conference on Computational Intelligence and Computing Technologies & AI 2026 Conference 
      </h1>

      {/* Description */}
      <p className="mt-4 max-w-3xl text-sm leading-relaxed text-slate-600 md:text-base">
      We successfully organized ICCICT 2026 as a prestigious international conference, bringing together researchers, academics, and industry professionals from across the globe. The conference served as a dynamic platform for presenting cutting-edge research, fostering meaningful collaborations, and addressing contemporary challenges in computational intelligence, computing technologies, and artificial intelligence. With participation from over 150 delegates representing more than 20 countries, ICCICT 2026 delivered an intellectually enriching, globally connected, and impactful experience for all participants.
      </p>
      ...
      <div className="mt-10 w-full max-w-4xl">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
            ...
            <div className="text-xs font-medium tracking-wide text-slate-500">Members</div>
            <div className="mt-1 text-base font-semibold text-slate-900">150+ Members</div>
          </div>
        </div>
