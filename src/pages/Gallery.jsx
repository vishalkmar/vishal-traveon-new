...
const Gallery = () => {
  ...
  const images = [
    ...
    // Tour images
   // Tour images
{ src: "/tour/1.jpg", category: "TOUR" },
{ src: "/tour/2.jpg",  category: "TOUR" },
{ src: "/tour/3.jpg",  category: "TOUR" },
{ src: "/tour/4.jpg", category: "TOUR" },
{ src: "/tour/5.jpg",category: "TOUR" },
{ src: "/tour/19.jpeg",category: "TOUR" },
{ src: "/tour/7.jpg",  category: "TOUR" },
{ src: "/tour/8.jpg", category: "TOUR" },
{ src: "/tour/9.jpg",  category: "TOUR" },
{ src: "/tour/10.jpg",  category: "TOUR" },
{ src: "/tour/11.jpg",  category: "TOUR" },
{ src: "/tour/12.jpg",  category: "TOUR" },
{ src: "/tour/13.jpeg", category: "TOUR" },
{ src: "/tour/14.jpeg",  category: "TOUR" },
{ src: "/tour/16.jpeg", category: "TOUR" },
{ src: "/tour/17.jpeg",  category: "TOUR" },
{ src: "/tour/18.jpeg",  category: "TOUR" },
{ src: "/tour/6.jpg", category: "TOUR" },
  ];
              ...
              return (
                <button
                  ...
                  className={`px-6 py-2 rounded-md transition-colors duration-200 ${
                    active ? "bg-[#28bccf] text-white" : "text-gray-700 hover:bg-gray-100"
                  }`}
                  aria-pressed={active}
                >
                  {category}
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-6">
          {filteredImages.map((image, index) => (
            <FadeIn key={`${image.src}-${index}`} delay={index * 60}>
              <GalleryImage {...image} onClick={() => handleImageClick(index)} />
            </FadeIn>
          ))}
        </div>
